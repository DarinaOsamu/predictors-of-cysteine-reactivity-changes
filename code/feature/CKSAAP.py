...
def main():
    ...
    #dataset0.to_excel(excel_writer=r'../../result/feature/CKSAAP_0_code.xlsx',index=False)
    #dataset1.to_excel(excel_writer=r'../../result/feature/CKSAAP_1_code.xlsx',index=False)
