...
def XGB_classifier(X_train, y_train):
    ...
    #clf.set_params(n_estimators=253)
    #clf.set_params(n_estimators=56)
...
def main():
    ...
    # 保存最优模型
    #pickle.dump(optimal_XGB1, open('../../result/classifier/XGBoost_SMOTE_PosNeg.pkl','wb'))
    '''
    ##############################
    ...
    # 保存最优模型
    pickle.dump(optimal_XGB2, open('../../result/classifier/XGBoost_SMOTE_IncreDecre.pkl','wb'))
