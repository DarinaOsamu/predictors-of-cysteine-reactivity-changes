...
def main():
    ...
    # 不进行SMOTE处理
    X2_ST, y2_ST = X2_train_test, y2_train_test
    #读取保存的标化器
    ...
    #pickle.dump(optimal_enet2, open('../../result/feature_selector/EN_baseline_IncreDecre.pkl','wb'))

    #读取得到的最优弹性网络
    optimal_enet2=pickle.load(open('../../result/feature_selector/EN_baseline_IncreDecre.pkl','rb'))
    ...
    pickle.dump(selector2, open('../../result/feature_selector/EN_Selector_baseline_IncreDecre.pkl', 'wb'))
