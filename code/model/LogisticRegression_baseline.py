...
def main():
    ...
    # 训练模型
    optimal_GaussianNB1=LogisticRegression_classifier(SS_X1_train_test, y1_train_test)

    # 保存最优模型
    pickle.dump(optimal_GaussianNB1, open('../../result/classifier/LogisticRegression_baseline_PosNeg.pkl','wb'))
    '''
    ##############################
    # 预测反应性升高还是降低
    ...
    # 训练模型
    optimal_GaussianNB2 = LogisticRegression_classifier(SS_X2_train_test, y2_train_test)

    # 保存最优模型
    pickle.dump(optimal_GaussianNB2, open('../../result/classifier/LogisticRegression_baseline_IncreDecre.pkl', 'wb'))
