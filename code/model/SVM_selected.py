...
def main():
    ...
    # 保存最优模型
    pickle.dump(optimal_SVM1, open('../../result/classifier/SVM_selected_PosNeg.pkl','wb'))
    '''
    ##############################
    # 预测反应性升高还是降低
    ...
    # 保存最优模型
    pickle.dump(optimal_SVM2, open('../../result/classifier/SVM_selected_IncreDecre.pkl', 'wb'))
