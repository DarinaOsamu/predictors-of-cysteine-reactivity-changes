...
def RF_classifier(X_train, y_train):
    ...
    #n_estimators_list = range(400,501,10)
    #n_estimators_list = range(50, 151, 10)
    n_estimators_list = [100]
    param_grid = {'n_estimators': n_estimators_list}

    '''
    clf.set_params(n_estimators=220)
    #clf.set_params(n_estimators=120)
...
def main():
    ...
    # 保存最优模型
    pickle.dump(optimal_RF1, open('../../result/classifier/RF_baseline_PosNeg.pkl','wb'))
    '''
    ##############################
    ...
    # 保存最优模型
    pickle.dump(optimal_RF2, open('../../result/classifier/RF_baseline_IncreDecre.pkl','wb'))
