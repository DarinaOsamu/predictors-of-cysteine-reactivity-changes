...
def main():
    ...
    # 训练模型
    optimal_LogisticRegression1 = LogisticRegression_classifier(SS_X1_train_test, y1_train_test)

    # 保存最优模型
    pickle.dump(optimal_LogisticRegression1, open('../../result/classifier/LogisticRegression_selected_PosNeg.pkl', 'wb'))
    ...
    # 训练模型
    optimal_LogisticRegression2 = LogisticRegression_classifier(SS_X2_train_test, y2_train_test)

    # 保存最优模型
    pickle.dump(optimal_LogisticRegression2, open('../../result/classifier/LogisticRegression_selected_IncreDecre.pkl', 'wb'))
